...
- Build/test gate runs against `CoreBankDemo.Rebuild.slnf` (both tiers); story 6.1 in `docs/backlog.md` tracks making the full solution the gate.
...
| A5 | `ARCHITECTURE.md` lists controllers that don't exist | Regenerate doc from code (story 8.1 in `docs/backlog.md`) |
