---
title: 'Instant rail: broadcast a transaction.cancelled event so a residual 202 can resolve'
type: 'feature'
created: '2026-09-08'
status: 'done'
baseline_commit: '73ccbb1151f291d701aa536fb263fbd4b098a355'
review_loop_iteration: 0
context:
  - '{project-root}/docs/bmad/constraints.md'
  - '{project-root}/docs/adr/ADR-020-instant-rail-timeout-cancellation.md'
