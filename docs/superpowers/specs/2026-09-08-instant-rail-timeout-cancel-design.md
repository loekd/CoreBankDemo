# Instant rail: cancel on budget exhaustion and answer 504 instead of 202

> **Status:** Implemented
> **Kind:** story spec
> **Original date:** 2026-09-08
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-instant-rail-timeout-cancel.md` on 2026-09-10
> **Related:** [ADR-018](../../adr/ADR-018-instant-payment-rail.md); [ADR-020](../../adr/ADR-020-instant-rail-timeout-cancellation.md)
