# DemoRunner Faults workspace — operator-steered Dev Proxy fault injection

> **Status:** Implemented
> **Kind:** story spec
> **Original date:** 2026-09-05
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-demorunner-fault-injection-workspace.md` on 2026-09-10
> **Related:** PR #8; [ADR-019](../../adr/ADR-019-generated-devproxy-session-config.md)
...
**Contract**
- `2026-09-03-demorunner-ux-experience-design.md` -- IA:53 (Faults workspace), Component Patterns:94-98, State Patterns:119,125-130, Accessibility:154,156-157, Flow 2:204-215
