...
> **Migrated from:** `docs/bmad/planning-artifacts/architecture/architecture-CoreBankDemo-2026-08-21/ARCHITECTURE-SPINE.md` on 2026-09-10
> **Related:** PR #2; [ADR-001](../../adr/ADR-001-idempotent-inbox.md), [ADR-008](../../adr/ADR-008-single-http-corebank-integration.md), [ADR-011](../../adr/ADR-011-renewable-redis-distributed-locking.md), [ADR-012](../../adr/ADR-012-three-tier-testing-and-coverage-gate.md), [ADR-015](../../adr/ADR-015-presentation-safe-terminal-demo-console.md), [ADR-016](../../adr/ADR-016-postgresql-testcontainers-persistence-testing.md)
...
- **Story-level cuts per epic** — owned by the epics and stories workflow; the epic order (E0–E7) is fixed in the brief addendum.
