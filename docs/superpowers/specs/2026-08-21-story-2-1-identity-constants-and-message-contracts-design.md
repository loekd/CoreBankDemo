...
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-2-1-identity-constants-and-message-contracts.md` on 2026-09-10
> **Related:** PR #2
...
- epic-2-context.md (removed in the 2026-09-10 migration; see git history) — Legacy Behavioral Reference section: exact algorithm, verbatim constants, contract member lists, AD-violation flags (do not copy violations)
