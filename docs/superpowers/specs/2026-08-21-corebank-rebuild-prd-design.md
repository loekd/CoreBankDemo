...
> **Migrated from:** `docs/bmad/planning-artifacts/prds/prd-CoreBankDemo-2026-08-21/prd.md` on 2026-09-10
> **Related:** PR #2
...
Jobs to be done: (a) demonstrate resilience patterns credibly; (b) demonstrate the workflow credibly; (c) regain a second-scale feedback loop (unit tests) below the minute-scale load test.
...
- **NFR-4 Process traceability:** every production change traces to a story; one commit per story.
