# Fix PaymentsAPI HTTP demo account mismatch

> **Status:** Implemented
> **Kind:** story spec
> **Original date:** 2026-08-30
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-fix-payments-http-demo-account-mismatch.md` on 2026-09-10
> **Related:** PR #2
...
- Review follow-up gaps captured without expanding this runtime-fix scope.
  deferred-work.md (removed in the 2026-09-10 migration; see git history)
