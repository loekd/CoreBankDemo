# Fix Dapr integration for replicated Aspire services

> **Status:** Implemented
> **Kind:** story spec
> **Original date:** 2026-08-30
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-fix-dapr-replica-integration.md` on 2026-09-10
> **Related:** PR #2; [ADR-014](../../adr/ADR-014-replicated-local-topology-stable-ingress.md)
...
- `docs/superpowers/specs/2026-08-21-corebank-rebuild-prd-design.md` -- update FR-21 from per-replica sidecars to per-logical-service pub/sub adapters.
- `docs/superpowers/specs/2026-08-21-architecture-spine-design.md` -- update AD-13's runtime invariant.
- `docs/superpowers/specs/2026-08-21-epics-and-stories-design.md`, epic-6-context.md (removed in the 2026-09-10 migration; see git history) -- align Story 6.1/6.3 forward-looking wording.
- `docs/superpowers/specs/2026-08-29-story-6-3-replicated-local-api-topology-design.md` -- apply the human amendment, remove the obsolete block, and return the story to `ready-for-dev` after the spike.
...
- AD-13 carries the amended invariant into the architecture spine.
  [`ARCHITECTURE-SPINE.md:111`](2026-08-21-architecture-spine-design.md)
...
- Epic stories now require logical adapters rather than replica-unique sidecars.
  [`epics.md:496`](2026-08-21-epics-and-stories-design.md)

- Epic context preserves the amended invariant for downstream story work.
  epic-6-context.md (removed in the 2026-09-10 migration; see git history)

- Story 6.3 records the successful spike and resumes ready-for-dev.
  [`spec-6-3-replicated-local-api-topology.md:102`](2026-08-29-story-6-3-replicated-local-api-topology-design.md)
