...
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-5-2-payment-intake-endpoint.md` on 2026-09-10
> **Related:** PR #2
...
- `CoreBankDemo.PaymentsAPI/Models/PaymentResponse.cs` -- restore the six-field frozen acknowledgement DTO recorded in `2026-08-21-epics-and-stories-design.md`.
