# Evidence payload bodies: request, response and CloudEvent on the Details pane

> **Status:** Implemented
> **Kind:** story spec
> **Original date:** 2026-09-10
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-evidence-payload-bodies.md` on 2026-09-10
> **Related:** PR #16; [ADR-015](../../adr/ADR-015-presentation-safe-terminal-demo-console.md)
