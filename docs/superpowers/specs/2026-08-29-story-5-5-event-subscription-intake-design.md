...
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-5-5-event-subscription-intake.md` on 2026-09-10
> **Related:** PR #2; [ADR-016](../../adr/ADR-016-postgresql-testcontainers-persistence-testing.md)
