...
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-2-2-idempotent-store.md` on 2026-09-10
> **Related:** PR #2
...
- epic-2-context.md (removed in the 2026-09-10 migration; see git history) — Legacy Behavioral Reference: old repository signatures/semantics (copy semantics, fix flagged violations); MessageConstants/interfaces from story 2.1 (committed f9a8945)
