...
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-6-2-renewable-redis-distributed-locking.md` on 2026-09-10
> **Related:** PR #2; [ADR-004](../../adr/ADR-004-leader-election-partitioning.md); [ADR-011](../../adr/ADR-011-renewable-redis-distributed-locking.md)
...
- `rg -n "DaprDistributedLockService|CooperativeLockCancellation|lockstore-redis|daprClient\\.(Lock|Unlock)" --glob '!docs/superpowers/specs/*story-3-2-*' --glob '!docs/superpowers/specs/*epic-3-*'` -- expected: no active production/orchestration references; historical frozen artifacts may still describe Story 3.2.
