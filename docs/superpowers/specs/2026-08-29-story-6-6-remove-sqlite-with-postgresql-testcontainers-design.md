...
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-6-6-remove-sqlite-with-postgresql-testcontainers.md` on 2026-09-10
> **Related:** PR #2; [ADR-012](../../adr/ADR-012-three-tier-testing-and-coverage-gate.md); [ADR-016](../../adr/ADR-016-postgresql-testcontainers-persistence-testing.md)
...
- `docs/adr/ADR-016-postgresql-testcontainers-persistence-testing.md` (new); `docs/adr/ADR-012-three-tier-testing-and-coverage-gate.md`; `../../constraints.md`; architecture spine -- accept and propagate the superseding test-tier decision without rewriting frozen completed stories.
