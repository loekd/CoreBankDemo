# DemoRunner: from cue player to operator console

> **Status:** Reference
> **Kind:** brief
> **Original date:** 2026-09-03
> **Migrated from:** `docs/bmad/planning-artifacts/briefs/brief-demorunner-console-2026-09-03/brief.md` on 2026-09-10
> **Related:** PR #2; [ADR-015](../../adr/ADR-015-presentation-safe-terminal-demo-console.md)
...
- `2026-08-29-story-7-4-reusable-terminal-demo-operator-console-design.md` — the current implementation contract.
- `2026-09-02-add-instant-payment-rail-design.md` — the instant rail the console must now drive.
