# Assertion API realignment

> **Status:** Implemented
> **Kind:** story spec
> **Original date:** 2026-08-31
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-7-1-assertion-api-realignment.md` on 2026-09-10
> **Related:** PR #2
...
- `../../constraints.md:5-11` -- canonical five-invariant wording; `:21-23` CoreBank↔Payments transport (Dapr pub/sub retained, out of this story's scope).
...
- [x] deferred-work.md (removed in the 2026-09-10 migration; see git history) -- appended an entry noting the `launchSettings.json` 5180-vs-5181 port mismatch, deferred out of this story's scope.
