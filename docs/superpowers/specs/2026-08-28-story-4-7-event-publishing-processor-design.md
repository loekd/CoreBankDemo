...
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-4-7-event-publishing-processor.md` on 2026-09-10
> **Related:** PR #2
...
- Prove transport and mapping failures remain kernel-owned retry outcomes.
  `tests/CoreBankDemo.CoreBankAPI.Tests/MessagingOutboxProcessorTests.cs`
