# DemoRunner: a working Stop/Start button for a resource

> **Status:** Implemented
> **Kind:** story spec
> **Original date:** 2026-09-10
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-demorunner-resource-lifecycle-recovery.md` on 2026-09-10
> **Related:** PR #17; [ADR-015](../../adr/ADR-015-presentation-safe-terminal-demo-console.md)
