...
- Interleaving proof: two partitions progress independently without cross-partition reordering.
  `tests/CoreBankDemo.PaymentsAPI.Tests/PaymentsOutboxProcessorTests.cs`

- Review-added: replays Program.cs's real registration sequence to close the DI-wiring verification gap.
  `tests/CoreBankDemo.PaymentsAPI.Tests/PaymentsOutboxWiringTests.cs`
...
- `2026-08-29-story-5-4-forwarding-processor-design.md` — records review triage, verification, and completion.
