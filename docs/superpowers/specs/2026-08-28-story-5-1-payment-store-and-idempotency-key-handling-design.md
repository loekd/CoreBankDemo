...
> **Migrated from:** `docs/bmad/implementation-artifacts/spec-5-1-payment-store-and-idempotency-key-handling.md` on 2026-09-10
> **Related:** PR #2; [ADR-010](../../adr/ADR-010-four-partition-system-invariant.md)
