...
public class InboxProcessingOptionsTests
{
    [Fact]
    public void SectionName_is_InboxProcessing()
    {
        InboxProcessingOptions.SectionName.Should().Be("InboxProcessing");
    }

    [Fact]
    public void Valid_configuration_binds_successfully()
    {
        var options = Bind<InboxProcessingOptions>(InboxProcessingOptions.SectionName, new()
        {
            ["PartitionCount"] = "4",
    ...
    {
        var act = () => Bind<InboxProcessingOptions>(InboxProcessingOptions.SectionName, new()
        {
            ["PartitionCount"] = "0",
    ...
    {
        var options = BindSectionAbsent<InboxProcessingOptions>(InboxProcessingOptions.SectionName);
