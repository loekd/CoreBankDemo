...
public class InboxMessageRepositoryTests
{
    ...
    public async Task StoreIfNewAsync_stores_once_and_reports_duplicates_as_already_exists()
    {
        ...
        var repository = new InboxMessageRepository(context, TimeProvider.System);
    ...
    public async Task Concurrent_independent_repositories_store_exactly_one_winner_for_the_same_identity()
    {
        ...
        var first = new InboxMessageRepository(firstContext, TimeProvider.System);
        var second = new InboxMessageRepository(secondContext, TimeProvider.System);
