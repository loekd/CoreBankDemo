...
public class InboxProcessorTests : SqliteCoreBankApiTestBase
{
    ...
    private sealed class SqliteTransactionExecutor(CoreBankDbContext dbContext, TimeProvider timeProvider) : ITransactionExecutor
    {
