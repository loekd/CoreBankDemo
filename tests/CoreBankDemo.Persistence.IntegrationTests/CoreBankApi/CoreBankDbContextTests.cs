...
/// model metadata (exact shape) and via real PostgreSQL constraint violations
/// (ADR-016 tier 2) — proving the uniqueness constraints actually bite, not
/// just that they were declared.
/// </summary>
public class CoreBankDbContextTests(PostgresContainerFixture fixture) : CoreBankApiPostgresTestBase(fixture)
{
    [Fact]
