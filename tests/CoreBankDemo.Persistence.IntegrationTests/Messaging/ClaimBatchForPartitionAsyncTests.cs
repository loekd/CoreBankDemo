...
/// Processing exclusion, and disjoint concurrent claims — against real
/// PostgreSQL (ADR-016 tier 2).
/// </summary>
public class ClaimBatchForPartitionAsyncTests(PostgresContainerFixture fixture) : MessagingPostgresTestBase(fixture)
{
    [Fact]
