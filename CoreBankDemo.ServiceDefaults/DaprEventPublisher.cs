...
/// only here (AD-6, alongside <see cref="DaprDistributedLockService"/>),
/// through its generic <c>PublishEventAsync&lt;TData&gt;</c> pub/sub API.
/// Pub/sub component and topic name are DI-configured via
/// <see cref="MessagingOutboxProcessingOptions"/> (story 3.1), not passed
/// per-call.
/// </summary>
/// <remarks>
/// Thin pass-through adapter: unlike <see cref="DaprDistributedLockService"/>,
